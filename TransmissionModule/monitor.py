...
def monitorStart():
    """ Determines if we've started receiving an actual transmission by identifying the start sequence.
    ...
    cache = []
    pulseWidth = 1
    while True:   # exit loop when cache=[True]*3 i.e. when a msg is coming through
        z = takeMeasurement()
